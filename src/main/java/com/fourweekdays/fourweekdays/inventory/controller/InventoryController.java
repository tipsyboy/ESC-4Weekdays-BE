...
import com.fourweekdays.fourweekdays.inventory.model.dto.request.InventoryFilterDto;
...
public class InventoryController {
    ...
    // 재고 목록 조회
    @GetMapping
    public ResponseEntity<BaseResponse<InventoryListDto>> inventoryList(InventoryFilterDto dto) {
