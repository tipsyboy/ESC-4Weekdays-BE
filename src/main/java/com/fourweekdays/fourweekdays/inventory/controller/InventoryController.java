...
public class InventoryController {
    ...
    @PostMapping("/summary")
    public ResponseEntity<BaseResponse<Page<InventorySummaryResponse>>> getInventorySummary(@RequestParam(defaultValue = "0") int page,
                                                                                            @RequestParam(defaultValue = "10") int size,
                                                                                            @RequestBody InventorySearchRequest request) {
        Page<InventorySummaryResponse> summaries = inventoryService.getInventorySummary(request, page, size);
